...
print("Ingrese 1er numero")
numero_1 = int(input())   #ingresar numeros por consola
print("Ingrese 2do numero")
numero_2 = int(input())
...
print("la potencia entre", numero_1 , "y" , numero_2 , "es", exponente)