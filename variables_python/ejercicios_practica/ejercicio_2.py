...
print("el resultado de sumar" , numero_1 , "y" , numero_2 , "es igual a" , suma)
# Resta
resta = numero_1 - numero_2
print("el resultado de restar" , numero_1 , "y" ,  numero_2 , "es igual a" , resta)
# División
division = numero_1 // numero_2
print("la division entre" , numero_1 , "y" , numero_2 , "es igual a", division)
# Multiplicación
multiplicacion = numero_1 * numero_2
print("la mutiplicacion entre" , numero_1 , "y" , numero_2 , "es igual a " , multiplicacion)